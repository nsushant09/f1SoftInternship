...
class Home : Fragment() {
    ...
    val onClickOpenBottomSheet : (LastWeek) -> Unit = { lastWeekObject ->
        ...
        informationBottomSheet.show(childFragmentManager, InformationBottomSheet.TAG)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.listOfCompanies.observe(viewLifecycleOwner, Observer{
            val adapter = LastWeekDataAdapter(requireContext(), it, onClickOpenBottomSheet)
